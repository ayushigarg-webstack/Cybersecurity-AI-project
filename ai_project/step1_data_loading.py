...
For Viva: Explain that KDD Cup 99 is the benchmark dataset for intrusion detection,
containing network connection records labeled as normal or various attack types.
"""
